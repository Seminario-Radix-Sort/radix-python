...
<h1 align='center'>
  Radixsort LSD com CountingSort - Implementação em Python
</h1>
...
1. Clone o repositório no diretório desejado:
  ```console
  git clone https://github.com/Seminario-Radix-Sort/radix-python.git
  cd radix-python
  ```
...
--- | --- | --- | --- | --- | ---
Ubuntu 22.04.4 LTS | Python 3.10.12 | Poetry (version 1.8.3) | Ryzen 5 5500U 2.1GHz | 2x4GB 3200MHz | SSD M.2 NVME 256GB (3500MB/s de Leitura x 1200MB/s de Escrita) 
